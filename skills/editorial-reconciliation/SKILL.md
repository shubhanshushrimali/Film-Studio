---
name: editorial-reconciliation
description: Reconcile selected shots, sequence order, and main timeline placements before a feature-film master is accepted.
...
1. Read `../../references/FEATURE_EDITORIAL_RECONCILIATION.md`.
...
4. Use `../../scripts/editorial_reconcile.py` for deterministic state changes or checks.
