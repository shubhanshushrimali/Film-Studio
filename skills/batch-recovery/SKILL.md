---
name: batch-recovery
description: Recover only failed, unfinished, and invalidated downstream ComfyUI jobs while preserving valid completed generation work.
...
1. Read `../../references/PARTIAL_BATCH_RECOVERY.md`.
...
4. Use `../../scripts/batch_recovery.py` for deterministic state changes or checks.
