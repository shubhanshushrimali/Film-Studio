---
name: sequence-production
description: Manage feature-film SEQ-### production boundaries so long films are planned, generated, reviewed, and approved in bounded sequence units.
...
1. Read `../../references/SEQUENCE_MANAGEMENT.md`.
...
4. Use `../../scripts/sequence_manager.py` for deterministic state changes or checks.
