...
description: Plan feature-scale local generation by declared RAM, VRAM, job dependencies, and resident model groups before heavy ComfyUI execution.
...
1. Read `../../references/GENERATION_BUDGETING.md`.
...
4. Use `../../scripts/generation_scheduler.py` for deterministic state changes or checks.
